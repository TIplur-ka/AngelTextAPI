package necode.angelitex.tiplur.angeltextapi.tools.Color;
...
public class ColorUtil {
    ...
    /**
     * Uses if version server >=1.16
     * @param string Your string for multicolor formatting
     */
    public static String MultiColor(String string) {
        return StringEscapeUtils.unescapeJava(
                org.bukkit.ChatColor.translateAlternateColorCodes('&',
                        string.replaceAll("&#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])", "&x&$1&$2&$3&$4&$5&$6")
                ));
    }
}
